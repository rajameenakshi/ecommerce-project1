...
<head>
    ...
    <title>Registration Form and Validation - Bootsnipp.com</title>
	...
	<div class="row">
        <div class="col-md-6">
            ...
            <label for="phonenumber"><span class="req">* </span> Phone Number: </label>
                    <input required type="text" name="phonenumber" id="phone" class="form-control phone" maxlength="28" onkeyup="validatephone(this);" placeholder="enter 10 digit number"/> 
            </div>
